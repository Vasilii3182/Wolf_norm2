...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/22 20:21:24 by ofranco           #+#    #+#             */
/*   Updated: 2017/09/22 21:41:35 by ofranco          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_half(char *buffer, int read_ret, char **line, const int fd)
{
...
int		get_next_line(const int fd, char **line)
{
	...
	current_fd = fd;
	*line = ft_strnew(0);
	return (ft_half(buffer, read_ret, line, fd));
}
